...
export const translations = {
  en: {
    ...
    hero: {
      ...
      lead: 'Third-year CTIS student at Bilkent University. I build software across test automation, frontend engineering, and Linux systems — most recently at Baykar and Turkcell.',
      work: 'View my work',
      cv: 'Download CV',
    ...
    education: {
      ...
      since: 'since {year}',
      metrics: ['Overall GPA', 'Class ranking', 'IELTS average', 'Expected graduation'],
  ...
  tr: {
    ...
    hero: {
      ...
      lead: 'Bilkent Üniversitesi CTIS bölümünde üçüncü sınıf öğrencisiyim. Test otomasyonu, frontend ve Linux sistemleri tarafında yazılım geliştiriyorum; en son Baykar ve Turkcell’de çalıştım.',
      work: 'Projelerim',
      cv: 'CV’mi indir',
    ...
    education: {
      ...
      since: '{year}’ten beri',
      metrics: ['Genel ortalama', 'Sınıf sıralaması', 'IELTS ortalaması', 'Beklenen mezuniyet'],
